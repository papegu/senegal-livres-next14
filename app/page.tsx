          ...
          <p className="mt-4 text-base text-gray-700">
            ...
            <div className="mt-6 flex flex-col items-center">
              ...
              <div className="flex gap-4 mt-2">
                <a href="https://facebook.com/serignebabacargueye" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                ...
                <a href="https://instagram.com/serignebabacargueye" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
